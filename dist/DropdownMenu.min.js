(function (global, factory) {
  ...
  const DropdownMenu = props => {
    ...
    const [animationClass, setAnimationClass] = React.useState(''); // Create a reference to this element, only used by the top level menu
    ...
    React__default['default'].createElement("ul", {
      className: `${!props.isEmbedded ? 'react-auto-dropdown-menu-expanded-top-level' : props.dropdownLocation === 'full-screen-right' ? 'react-auto-dropdown-menu-embedded-right' : 'react-auto-dropdown-menu-embedded'}  ${props.animate && animationClass}`,
      style: positionStyle
